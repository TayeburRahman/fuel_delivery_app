...
// const transferToBankWithInfo = async (req, res) => {
//   const { id } = req.params;
//   const data = req.body;
...
//   const dateOfBirth = JSON.parse(bank) 
...
//     await saveStripeAccount(account, existingUser, id, address, kycFront, kycBack, dob);
...
//     throw new ApiError(httpStatus.INTERNAL_SERVER_ERROR, "Country, city, and postal code are required" ); 
//   }
